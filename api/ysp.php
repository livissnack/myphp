...
$headers = [
        ...
        "Cookie: guid={$guid}; gr_user_id=131786db-5aeb-46b7-9186-415950dfe3d2; versionName=99.99.99; versionCode=999999; vplatform=109; platformVersion=Chrome; deviceModel=121; updateProtocol=1; seqId=1; request-id={$request_id}",
        "Yspappid: 519748109",
